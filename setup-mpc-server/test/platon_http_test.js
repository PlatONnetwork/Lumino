var Eth = require('@fksyuan/web3x/eth');
var Providers = require('@fksyuan/web3x/providers')
var Account = require('@fksyuan/web3x/account');
var utils = require('@fksyuan/web3x/utils');
var Contract = require('@fksyuan/web3x/contract');
var ethUtil = require('@alayanetwork/web3-utils');
var Address = require('@fksyuan/web3x/address');
var Wallet = require('@fksyuan/web3x/wallet');
let hrp = "atp";
var eth = undefined;
